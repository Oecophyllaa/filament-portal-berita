        ...
        <div id="search-cards" class="grid grid-cols-3 gap-[30px]">
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-[6px]">
                            <h3 class="text-lg leading-[27px] font-bold">
                                {{ substr($news->name, 0, 50) }} {{ strlen($news->name) > 70 ? '...' : '' }}
                            </h3>
            ...
            @empty
                <div class="col-span-3 text-center">
                    <p class="text-lg font-semibold">No news available in this category.</p>
                </div>
            @endforelse
    ...
    <section id="Advertisement" class="max-w-[1130px] mx-auto flex justify-center mt-[70px]">
        <div class="flex flex-col gap-3 shrink-0 w-fit">
            ...
            <p class="font-medium text-sm leading-[21px] text-[#A3A6AE] flex gap-1">
                Our Advertisement <a href="#" class="w-[18px] h-[18px]"><img src="{{ asset('images/icons/message-question.svg') }}"
                        alt="icon" /></a>
            </p>
        </div>
    </section>
