...
<body class="font-[Poppins]">
    ...
    <section id="heading" class="max-w-[1130px] mx-auto flex items-center flex-col gap-[30px] mt-[70px]">
        ...
        <form action="{{ route('front.search') }}" method="GET">
            ...
            <label for="search-bar"
                ...
                <input autocomplete="off" type="text" id="search-bar" name="keyword" placeholder="Search hot trendy news today..."
    ...
    <section id="search-result" class="max-w-[1130px] mx-auto flex items-start flex-col gap-[30px] mt-[70px] mb-[100px]">
        ...
        <div id="search-cards" class="grid grid-cols-3 gap-[30px]">
            ...
            @empty
                <div
                    class="flex flex-col gap-4 p-[26px_20px] transition-all duration-300 ring-1 ring-[#EEF0F7] rounded-[20px] overflow-hidden bg-white">
                    <h3 class="text-lg leading-[27px] font-bold">No articles found for "{{ $keyword }}"</h3>
                    <p class="text-sm leading-[21px] text-[#A3A6AE]">Please try a different keyword.</p>
                </div>
            @endforelse
